  ...
  steps: [
    {
      ...
      fields: [
        ...
        { key: 'postSize', label: 'დგარების ზომა', value: (m) => m.postSize, patch: (v) => ({ postSize: v }) },
        { key: 'cellSide', label: 'ბადის უჯრედის გვერდების სიგრძე', value: (m) => m.cellSide, patch: (v) => ({ cellSide: v }) },
