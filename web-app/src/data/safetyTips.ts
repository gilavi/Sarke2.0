...
export const safetyTips: Record<string, SafetyTip> = {
  foundation: {
    ...
    checklist: [
      ...
      'Install protective systems (sloping, shoring, or shielding)',
      'Maintain materials and equipment at least 2 feet from edge',
      'Test for atmospheric hazards in trenches deeper than 4 feet',
      'Provide safe means of entry and exit within 25 feet of workers',
      'Keep water accumulation pumped out',
  ...
  scaffolding: {
    ...
    checklist: [
      ...
      'Ensure planking is scaffold-grade and extends 6 inches beyond supports',
      'Install guardrails on all open sides and ends above 10 feet',
      'Provide access via internal ladders or stair towers',
      'Maintain level, stable footing on solid ground or mud sills',
    ...
    regulations: [
      ...
      'OSHA 1926.452 - Additional Requirements for Specific Scaffolds',
  ...
  crane: {
    ...
    checklist: [
      ...
      'Inspect crane daily using manufacturer checklist',
      'Calculate load weight and rigging configuration before lifting',
      'Maintain minimum 10-foot clearance from overhead power lines',
      'Establish and barricade swing radius exclusion zone',
      'Use qualified signal person with standard hand signals',
      'Test hoist brakes and load line before critical lifts',
  ...
  structure: {
    ...
    checklist: [
      ...
      'Establish controlled decking zones with proper access restrictions',
      'Inspect all connections before releasing crane hooks',
      'Brace structural frames during erection sequence',
      'Design formwork for full concrete load plus equipment and workers',
      'Never place concrete on unsupported forms',
      'Strip forms only when concrete reaches specified strength',
      'Use proper shoring reshoring for multi-story pours',
    ],
    regulations: [
      'OSHA 29 CFR 1926.750 - Steel Erection',
      'OSHA 1926.700 - Concrete and Masonry Construction',
  ...
  barriers: {
    ...
    checklist: [
      ...
      'Ensure top rail height is 42 inches (+/- 3 inches)',
      'Install toe boards minimum 3.5 inches high on all guardrails',
      'Cover or barricade all floor holes and openings immediately',
      'Use hole covers secured and marked "DO NOT REMOVE"',
      'Inspect barriers daily for damage or displacement',
      'Replace any barrier component that fails inspection',
    ],
    regulations: [
  ...
  ppe: {
    ...
    checklist: [
      ...
      'Wear safety glasses with side shields in all work areas',
      'Use high-visibility Class 2 or 3 vests in traffic or low light',
      'Ensure steel-toe or composite-toe boots with ankle support',
      'Provide hearing protection when noise exceeds 85 dB',
      'Use respiratory protection during dust-generating operations',
      'Inspect all PPE before each use and replace damaged items',
    ],
    regulations: [
