/**
 * Hubble brand mark — the "H" logo, identical to the mobile app icon
 * (`assets/icon.png`) and the SVG favicon. `fill="currentColor"`, so the colour
 * is driven by the surrounding `text-*` class (e.g. orange on a dark tile to
 * mirror the mobile icon). Single source of truth for the logo across the web
 * app (dashboard chrome, auth screens, landing). Don't reintroduce the generic
 * `ShieldCheck` placeholder for branding.
 */
