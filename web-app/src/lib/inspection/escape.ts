 ...
 *
 * Web-app mirror of the Expo app's `lib/inspection/escape.ts`. Kept in sync by
 * hand (the `@root` import of the Expo tree is banned by eslint for everything
 * outside `@root/lib/shared/*`). This is the single source of truth for the
 * web-app's schema-driven inspection PDF engine under `lib/inspection/`.
 */
