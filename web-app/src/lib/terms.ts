...
export const termsKa: TermsBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        'ანგარიშის შექმნისას თქვენი პერსონალური მონაცემები (სახელი, გვარი, ელ-ფოსტა), ' +
        'შემოწმების აქტის მონაცემები, ფოტოები და ხელმოწერები ინახება Supabase-ის ' +
        'უსაფრთხო ინფრასტრუქტურაში. წვდომა შეზღუდულია თქვენი ანგარიშისთვის RLS პოლიტიკებით.',
    },
    {
      title: '3. ფოტო და ხელმოწერის შეგროვება',
      body:
        'აპი აგროვებს ფოტოებს და ხელმოწერებს მხოლოდ შემოწმების აქტის PDF ანგარიშში ' +
    ...
    },
    {
      ...
      body:
        ...
        'მონაცემთა დაცვის კანონს. შემოწმების აქტის შედეგები უნდა გამოიყენოს მხოლოდ ' +
