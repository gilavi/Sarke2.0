...
export const CP_ITEMS: CPChecklistEntry[] = [
  { id: 1, section: 'A', label: 'ძირის ფილები',       description: 'პლატფორმის ძირის (ფილების) მდგომარეობა - ბზარები, დეფორმაცია, კოროზია თუ არის - ცუდია' },
  { id: 2, section: 'A', label: 'მზიდი ჩარჩო',        description: 'მზიდი ჩარჩოს (ლითონის) მდგომარეობა - ბზარი, გახსნილი, დეფორმირებული - ცუდია' },
  { id: 3, section: 'A', label: 'სვეტები',             description: 'სვეტების (ვერტიკალური დგარების) მდგომარეობა - დეფორმირებული, გამოძრავდა, მოშვებული - ცუდია' },
  { id: 4, section: 'A', label: 'ანკერული გამაგრება', description: 'ანკერული გამაგრებების მდგომარეობა - სიმჭიდროვე დარღვეულია, კოროზიულია - ცუდია' },
  { id: 5, section: 'B', label: 'გვ. მოაჯირის სიმ.',  description: 'გვერდითი მოაჯირების სიმაღლე (მინ. 90–120 სმ)' },
  { id: 6, section: 'B', label: 'მოაჯირის სიმტკ.',    description: 'მოაჯირების სტრუქტურული სიმტკიცე - აკლია, ბზარი - ცუდია' },
  { id: 7, section: 'B', label: 'წინა მოაჯირი',       description: 'წინა მოძრავი (დასაკეცი) მოაჯირების ფუნქციონირება - გახსნა/დაკეტვა - თუ არ ფუნქციონირებს ცუდია' },
  { id: 8, section: 'B', label: 'ჩამკეტი მოწყ.',      description: 'მოძრავი მოაჯირის ჩამკეტი მოწყობილობა - არ გააჩნია, არ იკეტება - ცუდია' },
  { id: 9, section: 'B', label: 'კავშირები',           description: 'მოაჯირის ყველა კავშირი (სახსრები) - ბზარი, დაზიანებული - ცუდია' },
];
