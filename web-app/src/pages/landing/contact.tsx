...
export function ContactHero() {
  return (
    <section className="bg-[#F5F3EE] pt-32 pb-16 px-5">
    ...
    <section className="py-20 px-5 bg-white">
      <div className="mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-neutral-200 px-4 py-3 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100"
              />
              <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-500 py-3 text-sm font-semibold text-white hover:bg-brand-600 transition-colors">
                <Send size={15} /> გაგზავნა
              </button>
            </form>
          ) : (
            <div className="flex flex-col items-center gap-2 rounded-2xl border border-brand-100 bg-brand-50/50 py-10 text-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <a href="mailto:hello@hubble.ge" className="flex items-center gap-4 rounded-2xl border border-neutral-200 bg-white p-5 hover:border-brand-300 transition-colors">
