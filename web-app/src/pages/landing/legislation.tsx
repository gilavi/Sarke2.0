...
export function LegislationHero() {
  return (
    <section className="bg-[#F5F3EE] pt-32 pb-20 px-5">
        ...
        >
          {REGULATIONS.map(item => (
            <motion.a
              ...
              target="_blank"
              rel="noreferrer"
              className="group rounded-2xl border border-neutral-200 bg-white p-6 hover:border-brand-300 transition-colors"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start gap-2">
                    ...
                    <ExternalLink size={15} className="shrink-0 text-neutral-400 group-hover:text-brand-600 transition-colors" />
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {blogArticles.map((a, i) => (
            <motion.a
              ...
              className="flex flex-col rounded-2xl border border-neutral-200 bg-white overflow-hidden hover:border-brand-300 transition-colors"
            >
