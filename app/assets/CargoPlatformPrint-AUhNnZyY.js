...
`;function Y(r){const{inspection:e,projectName:p="პროექტი",photoUrls:c}=r,n=e.id.slice(-8).toUpperCase(),g=v(e.completedAt??e.inspectionDate),u=`
  ...
  `;function s(t){return t==="good"?'<span class="pill pill-good">✓ კარგი</span>':t==="fix"?'<span class="pill pill-fix">✗ გამოსასწ.</span>':t==="na"?'<span class="pill pill-na">— N/A</span>':'<span class="pill pill-null">—</span>'}let o="",S="";for(const t of M){t.section!==S&&(S=t.section,o+=`
        <tr class="cl-cat-row">
  ...
  `,P=t=>e.verdict===t?"selected":"",E=t=>e.verdict===t?"checked":"",B=`
    ...
    <div class="verdict-block">
      ${["approved","conditional","rejected"].map(t=>`
        <div class="verdict-option ${P(t)}">
          ...
          <span class="verdict-label">${i(O[t])}</span>
        </div>
      `).join("")}
    </div>
