...
`;function J(r){const{inspection:e,projectName:p="პროექტი",photoUrls:c}=r,n=e.id.slice(-8).toUpperCase(),g=v(e.completedAt??e.inspectionDate),u=`
    <div class="header">
...
</html>`}function nt(){var f,y,h;const{id:r}=N(),[e]=U(),p=e.get("preview")==="1",c=b.useRef(null),n=j({queryKey:["cargoPlatformInspection",r],queryFn:()=>W(r),enabled:!!r}),g=j({queryKey:["project",(f=n.data)==null?void 0:f.projectId],queryFn:()=>q(n.data.projectId),enabled:!!((y=n.data)!=null&&y.projectId)}),[u,k]=b.useState({}),[x,m]=b.useState(!1);if(b.useEffect(()=>{if(!n.data)return;const s=[...n.data.items.flatMap(o=>o.photo_paths??[]),...n.data.summaryPhotos];if(!s.length){m(!0);return}Promise.all(s.map(async o=>[o,await G(o)])).then(o=>{k(Object.fromEntries(o)),m(!0)}).catch(()=>m(!0))},[n.data]),!n.data)return d.jsx("p",{style:{padding:24},children:n.isLoading?"იტვირთება…":"ვერ მოიძებნა."});if(!g.isSuccess||!x)return d.jsx("p",{style:{padding:24},children:"იტვირთება…"});const w=J({inspection:n.data,projectName:(h=g.data)==null?void 0:h.name,photoUrls:u});return d.jsxs(d.Fragment,{children:[d.jsxs("div",{style:{position:"sticky",top:0,background:"#FAFAFA",borderBottom:"1px solid #E5E7EB",padding:"10px 16px",display:"flex",gap:8,justifyContent:"flex-end",zIndex:10},children:[d.jsx("button",{onClick:()=>window.history.back(),style:{padding:"6px 14px",borderRadius:6,fontSize:13,fontWeight:600,cursor:"pointer",border:"1px solid #D1D5DB",background:"#fff"},children:"დახურვა"}),d.jsx("button",{onClick:()=>{var s,o;return(o=(s=c.current)==null?void 0:s.contentWindow)==null?void 0:o.print()},style:{padding:"6px 14px",borderRadius:6,fontSize:13,fontWeight:600,cursor:"pointer",border:"1px solid #2F855A",background:"#2F855A",color:"#fff"},children:"ბეჭდვა"})]}),d.jsx("iframe",{ref:c,srcDoc:w,style:{width:"100%",height:"calc(100vh - 53px)",border:"none",display:"block"},title:"ტვირთის მიმღები პლატფორმის შემოწმების აქტი",onLoad:()=>{var s,o;p||(o=(s=c.current)==null?void 0:s.contentWindow)==null||o.print()}})]})}export{nt as default};
