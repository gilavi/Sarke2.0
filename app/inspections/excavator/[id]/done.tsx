...
//
// Reached immediately after the excavator wizard conclusion step finishes.
...
export default function ExcavatorInspectionDoneScreen() {
  ...
  const verdictLabel = (verdict: string | null | undefined) => {
    if (!verdict) return '';
    return EXCAVATOR_VERDICT_LABEL[verdict as keyof typeof EXCAVATOR_VERDICT_LABEL]?.split(' – ')[0] ?? verdict;
  };
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {loading ? (
          ...
          <Card>
            ...
            <Text style={styles.inspTitle}>ექსკავატორის ინსპექცია</Text>
