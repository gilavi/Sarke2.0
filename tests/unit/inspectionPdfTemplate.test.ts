...
describe('buildInspectionPdfTemplate', () => {
  ...
  // Legacy signer-name + signature_png_url assertion removed: the 2026-05-26
  // inspection signatures redesign replaced SignatureRecord[] with
  // signaturesSession, and this test no longer feeds signature data into
  // the template.
