...
interface SvgPalette { tint: string; stroke: string; }
const SvgCtx = createContext<SvgPalette>({ tint: '#E8F5F0', stroke: '#1D9E75' });
...
function LevelSurface() {
  ...
  return (
    <Svg viewBox="0 0 72 72" width="100%" height="100%">
      ...
      <Rect x={6} y={53} width={22} height={6} rx={3} fill="white" stroke={c.stroke} strokeWidth={1} />
      <Circle cx={17} cy={56} r={2.5} fill={c.stroke} />
      <Circle cx={57} cy={52} r={8} fill={c.stroke} opacity={0.15} />
      <Path d="M52 52 L56 57 L63 47" fill="none" stroke={c.stroke} strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
function Distance25() {
  ...
  return (
    <Svg viewBox="0 0 72 72" width="100%" height="100%">
      ...
      <Line x1={28} y1={33} x2={44} y2={33} stroke={c.stroke} strokeWidth={1.5} strokeDasharray="3,2" />
      <Path d="M32 30 L28 33 L32 36" fill="none" stroke={c.stroke} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M40 30 L44 33 L40 36" fill="none" stroke={c.stroke} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <Rect x={28} y={21} width={18} height={9} rx={2} fill={c.stroke} />
...
function Jack() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={35} y={24} width={10} height={54} rx={2} fill={c.stroke} />
...
function BasePlate() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={16} y={58} width={48} height={14} rx={2} fill={c.stroke} />
...
function VertFrame() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      <Rect x={14} y={8} width={6} height={72} rx={2.5} fill={c.stroke} />
      <Rect x={60} y={8} width={6} height={72} rx={2.5} fill={c.stroke} />
      <Line x1={20} y1={12} x2={60} y2={76} stroke={c.stroke} strokeWidth={2.5} strokeLinecap="round" />
      <Line x1={20} y1={76} x2={60} y2={12} stroke={c.stroke} strokeWidth={2.5} strokeLinecap="round" />
      ...
      <Circle cx={20} cy={13} r={5} fill="#0F6E56" stroke={c.tint} strokeWidth={1.5} />
      <Circle cx={60} cy={13} r={5} fill="#0F6E56" stroke={c.tint} strokeWidth={1.5} />
      <Circle cx={20} cy={77} r={5} fill="#0F6E56" stroke={c.tint} strokeWidth={1.5} />
      <Circle cx={60} cy={77} r={5} fill="#0F6E56" stroke={c.tint} strokeWidth={1.5} />
    </Svg>
  );
}
...
function HatchPlatform() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={32} y={46} width={16} height={16} rx={1} fill="none" stroke={c.stroke} strokeWidth={1.5} strokeDasharray="3,2" />
      <Rect x={32} y={26} width={16} height={16} rx={1} fill={c.stroke} />
...
function ToeBoard() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={15} y={30} width={10} height={32} rx={1} fill={c.stroke} />
      {[34, 38, 42, 46, 50, 54].map(y => (
        <Line key={y} x1={17} y1={y} x2={23} y2={y} stroke="#0F6E56" strokeWidth={0.9} />
      ))}
      <Line x1={27} y1={30} x2={27} y2={44} stroke={c.stroke} strokeWidth={1} strokeDasharray="2,2" />
      <Path d="M24 33 L27 30 L30 33" fill="none" stroke={c.stroke} strokeWidth={1.2} strokeLinecap="round" />
      <Path d="M24 41 L27 44 L30 41" fill="none" stroke={c.stroke} strokeWidth={1.2} strokeLinecap="round" />
    </Svg>
  );
}
...
function TopMidRail() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={12} y={12} width={56} height={6} rx={2} fill={c.stroke} />
      <Rect x={12} y={36} width={56} height={6} rx={2} fill={c.stroke} />
      ...
      <Line x1={6} y1={15} x2={6} y2={39} stroke={c.stroke} strokeWidth={1.2} />
      <Path d="M4 17 L6 14 L8 17" fill="none" stroke={c.stroke} strokeWidth={1.2} strokeLinecap="round" />
      <Path d="M4 37 L6 40 L8 37" fill="none" stroke={c.stroke} strokeWidth={1.2} strokeLinecap="round" />
    </Svg>
  );
}
...
function SideRail() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={8} y={14} width={6} height={50} rx={2.5} fill={c.stroke} />
      <Rect x={8} y={14} width={36} height={5} rx={2} fill={c.stroke} />
      <Line x1={12} y1={20} x2={38} y2={60} stroke={c.stroke} strokeWidth={2} strokeLinecap="round" />
    </Svg>
  );
}
...
function Ladder() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={16} y={8} width={6} height={74} rx={2.5} fill={c.stroke} />
      <Rect x={38} y={8} width={6} height={74} rx={2.5} fill={c.stroke} />
      {[18, 28, 38, 48, 58, 68].map(y => (
        <Line key={y} x1={16} y1={y} x2={44} y2={y} stroke={c.stroke} strokeWidth={3.5} strokeLinecap="round" />
      ))}
      <Path d="M44 8 Q54 8 54 18" fill="none" stroke={c.stroke} strokeWidth={3} strokeLinecap="round" />
    </Svg>
  );
}
...
function Anchor() {
  ...
  return (
    <Svg viewBox="0 0 80 88" width="100%" height="100%">
      ...
      <Rect x={10} y={41} width={38} height={6} rx={2.5} fill={c.stroke} />
      ...
      <Rect x={48} y={36} width={7} height={16} rx={1} fill={c.stroke} />
...
function Photo() {
  ...
  return (
    <Svg viewBox="0 0 80 80" width="100%" height="100%">
      ...
      <Circle cx={37} cy={42} r={14} fill="#2C2C2A" stroke={c.stroke} strokeWidth={2} />
      <Circle cx={37} cy={42} r={9} fill="#1D1D1B" />
      <Circle cx={37} cy={42} r={5.5} fill={c.stroke} opacity={0.35} />
...
function Conclusion() {
  ...
  return (
    <Svg viewBox="0 0 80 80" width="100%" height="100%">
      <Rect x={14} y={14} width={46} height={58} rx={3} fill={c.tint} stroke={c.stroke} strokeWidth={1.5} />
      <Rect x={28} y={8} width={18} height={12} rx={3.5} fill={c.stroke} />
      ...
      <G originX={46} originY={50} rotation={-38}>
        <Rect x={46} y={50} width={5} height={20} rx={2.5} fill={c.stroke} />
      </G>
...
export const QuestionAvatar = memo(function QuestionAvatar({
  ...
  if (variant === 'banner') {
    ...
    return (
      <SvgCtx.Provider value={svgPalette}>
        <View
          style={{
            width: '100%',
            height: bannerHeight,
